...
- [x] **CI/CD GitHub Actions** : Externalisation des crons hors Vercel (workflow pipeline orchestré + garde-fou de skip process après ingest vide). Scripts standalone avec chargement `dotenv`.
